...
$(document).ready(function() {
	...
	about = 'My name is Clark Yu, and I am a Data Science.',
	...
	skills = "Main: Python, R, SQL, Dimple.js , HTLM5, CSS3, GIT and Github.\n Familiar with: Machine Learning, D3.JS.",
	contact = "Contact me via Email  -> C.Yu.4@warwick.ac.uk";
	// let
	...
	function generateContactHTML() {
		...
		let githubLink = $('<a>Github</a>').attr({
			'href': 'https://github.com/clarkyu2016',
			'target': '_blank'
		});

		let twitterLink = $('<a>Twitter</a>').attr({
			'href': 'https://twitter.com/clarkYu1993',
			'target': '_blank'
		});

		let linkedinLink = $('<a>LinkedIn</a>').attr({
			'href': 'https://www.linkedin.com/in/clarkyu1993/',
			'target': '_blank'
		})
	...
	let shortBio = 'Self-taught data analyst, absolutely passionate about coding and the future of technology. I am constantly learning and expanding my skills. While you are reading this, I am probably busy learning something new.';
	...
	function init() {
		...
		setTimeout(function() {
			let MatrixEl = addToTerminal(Matrix,  typeSpeedSlow, true);
		}, 3500);

		setTimeout(function() {
			let whiterabbitEl = addToTerminal(whiterabbit,  typeSpeedSlow, true);
		}, 6700);
